...
+-------------------+-----------------------------+-------------------------------+-----------------------------------------------+------------------------------------------------+---------------------------------------------------------------------------------------------------------------+
| Application Usage | seconds of an App in        | ms of an App in Foreground    | 15 minute time intervals starting at          | dynamic time intervals starting at midnight    | iOS: category of app for non-Apple apps & name of app for Apple apps; Android: always app name and category   |
...
Coming soon: Wearables (Garmin & Fitbit)
